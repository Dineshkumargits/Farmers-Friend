...
//        categories_crop.add(getString(R.string.Maize));
        ...
        categories_city.add(getString(R.string.Visakhapatnam));
        categories_city.add(getString(R.string.Vijayawada));
        categories_city.add(getString(R.string.Guntur));
        categories_city.add(getString(R.string.Nellore));
        categories_city.add(getString(R.string.Kurnool));
        categories_city.add(getString(R.string.Kadapa));
        categories_city.add(getString(R.string.Rajahmundry));
        categories_city.add(getString(R.string.Kakinada));
        categories_city.add(getString(R.string.Tirupati));
        categories_city.add(getString(R.string.Eluru));
        categories_city.add(getString(R.string.Anantapur));
        categories_city.add(getString(R.string.Vizianagaram));
        categories_city.add(getString(R.string.Ongole));
        categories_city.add(getString(R.string.Nandyal));
        categories_city.add(getString(R.string.Machilipatnam));
        categories_city.add(getString(R.string.Adoni));
        categories_city.add(getString(R.string.Tenali));
        categories_city.add(getString(R.string.Proddatur));
        categories_city.add(getString(R.string.Chittoor));
        categories_city.add(getString(R.string.Hindupur));
        categories_city.add(getString(R.string.Bhimavaram));
        categories_city.add(getString(R.string.Madanapalle));
        categories_city.add(getString(R.string.Guntakal));
        categories_city.add(getString(R.string.Srikakulam));
        categories_city.add(getString(R.string.Dharmavaram));
        categories_city.add(getString(R.string.Gudivada));
        categories_city.add(getString(R.string.Narasaraopet));
        categories_city.add(getString(R.string.Tadipatri));
        categories_city.add(getString(R.string.Tadepalligudem));
        categories_city.add(getString(R.string.Amaravati));
        categories_city.add(getString(R.string.Chilakaluripet));
